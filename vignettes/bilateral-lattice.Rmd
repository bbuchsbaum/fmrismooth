...
ggplot(viz3, aes(x, y, fill = val)) +
  geom_raster() + coord_fixed() + scale_y_reverse() +
  scale_fill_gradient(low = "black", high = "white") +
  facet_wrap(~method) + theme_minimal(base_size = 10) +
  labs(title = "3D: effect of sigma_r on a mid-slice", x = NULL, y = NULL, fill = "intensity")
```
...
ggplot(viz4, aes(x, y, fill = val)) +
  ...
  scale_fill_gradient(low = "black", high = "white") +
  facet_wrap(~method) + theme_minimal(base_size = 10) +
  labs(title = "4D: temporal coupling on a mid-slice/frame", x = NULL, y = NULL, fill = "intensity")
```
